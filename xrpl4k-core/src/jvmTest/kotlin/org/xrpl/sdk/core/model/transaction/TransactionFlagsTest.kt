...
class TransactionFlagsTest : FunSpec({
    ...
    // ── TrustSet flags match XRPL spec ───────────────────────────────────────
    ...
    // ── OfferCreate flags match XRPL spec ────────────────────────────────────
    ...
    // ── NFTokenMint flags match XRPL spec ────────────────────────────────────
    ...
    // ── AMMDeposit flags match XRPL spec ─────────────────────────────────────
    ...
    // ── AMMWithdraw flags match XRPL spec ────────────────────────────────────
    ...
    // ── AccountSetFlag values are not bitmasks ───────────────────────────────

    test("AccountSetFlag values are sequential integers, not bitmasks") {
        // AccountSetFlag values are passed to SetFlag/ClearFlag fields directly,
        // unlike TransactionFlags which are bitmask values
        AccountSetFlag.asfRequireDest shouldBe 1u
        AccountSetFlag.asfRequireAuth shouldBe 2u
        AccountSetFlag.asfDisallowXRP shouldBe 3u
        // Note: there is no value 11 — the sequence has a gap
    }
})
